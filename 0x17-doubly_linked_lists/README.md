In this project, the focus is on doubly linked list, those lists which contain items holding three minimum possible values, the value, pointer to the next node and pointer to the previous node. Below are the questions to be answered in this project.
